...
import input_module_puppet_enterprise_extended_details as input_module
...
'''
    ...
    Add your modular input logic to file input_module_puppet_enterprise_extended_details.py
'''
class ModInputpuppet_enterprise_extended_details(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputpuppet_enterprise_extended_details, self).__init__("splunktaforpuppetenterprise", "puppet_enterprise_extended_details", use_single_instance)
...
if __name__ == "__main__":
    exitcode = ModInputpuppet_enterprise_extended_details().run(sys.argv)
    sys.exit(exitcode)
